...
<head>
  ...
  <script type="text/javascript" src="//use.typekit.net/crh1bjp.js"></script>
  <script type="text/javascript">try{Typekit.load();}catch(e){}</script>

  <script src="http://d7.davidfugate.com/sites/all/themes/dpf/js/libs/modernizr-2.6.2.min.js"></script>
</head>
