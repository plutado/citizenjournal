...
<?php
  drupal_add_css(path_to_theme() . '/css/gumby.css');
  drupal_add_css(path_to_theme() . '/css/global.css');
  drupal_add_css(path_to_theme() . '/css/size-small.css');
  drupal_add_css(path_to_theme() . '/css/size-medium.css');
  drupal_add_css(path_to_theme() . '/css/size-large.css');
?>
...
$(document).ready(function () {
  ...
  for (var num=0, len=yt_videos.length; num<len; ++num){
    yt_html = yt_html + "<div class='four columns column-"+ num +"'><a class='skip' href='#toolbar' gumby-easing='easeInOutQuad' gumby-goto='#yt_container' gumby-duration='2000' onclick='change_embeded(\"" + yt_videos[num] + "\")'><div class='play'><img src='sites/all/themes/dpf/images/play.png' /></div><div class='video-thumbnail'><img src='http://img.youtube.com/vi/"+yt_videos[num]+"/hqdefault.jpg' width='480' height='360'/></div></a><h4 class='video-title video-title-"+num+"'><span class='title'>"+yt_titles[num]+"</span><div style='display:none;' class='currently-playing'> (currently selected) </div></h4></div>";
...
<script src="sites/all/themes/dpf/js/libs/plugins.js"></script>
<script src="sites/all/themes/dpf/js/libs/jquery.fitvids.js"></script>
<script gumby-path="/js/libs" src="sites/all/themes/dpf/js/libs/gumby.min.js"></script>
